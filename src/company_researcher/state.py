...
from company_researcher.model import CompanyInfo

DEFAULT_EXTRACTION_SCHEMA = CompanyInfo.model_json_schema()
...
class InputState:
    ...
    extraction_schema: CompanyInfo = field(
...
class OverallState:
    ...
    info: CompanyInfo = field(default=None)
    """
