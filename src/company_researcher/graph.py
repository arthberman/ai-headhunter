...
from company_researcher.state import InputState, OutputState, OverallState
from company_researcher.utils import deduplicate_and_format_sources, format_all_notes
...
class Queries(BaseModel):
    """Queries generated by the company researcher graph."""
...
class ReflectionOutput(BaseModel):
    """Reflection output from the company researcher graph."""

    is_satisfactory: bool = Field(
        description="True if all required fields are well populated, False otherwise",
        alias="isSatisfactory",
    )
...
def compile_company_researcher_graph() -> StateGraph:
    """Compile the company researcher graph."""
    builder = StateGraph(
        OverallState,
        input=InputState,
        output=OutputState,
