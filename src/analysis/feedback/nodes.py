...
def node_reformulate_human_feedback(
    ...
    prompt = hub.pull("analysis-feedback-reformulate:development")
...
def node_extract_profile_related_elements(
    ...
    # Pull the prompt from the hub
    prompt = hub.pull("analysis-feedback-extract-profile:development")
...
def node_extract_scorecard_related_elements(
    ...
    # Pull the prompt from the hub
    prompt = hub.pull("analysis-feedback-extract-scorecard:development")
...
def node_synthesize_feedback(
    ...
    # Pull the prompt from the hub
    prompt = hub.pull("analysis-feedback-synthesize:development")
