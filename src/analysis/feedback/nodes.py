...
def node_reformulate_human_feedback(
    ...
    prompt = get_prompt("analysis-feedback-reformulate")
...
def node_extract_profile_related_elements(
    ...
    # Pull the prompt from the hub
    prompt = get_prompt("analysis-feedback-extract-profile")
...
def node_extract_scorecard_related_elements(
    ...
    # Pull the prompt from the hub
    prompt = get_prompt("analysis-feedback-extract-scorecard")
...
def node_synthesize_feedback(
    ...
    # Pull the prompt from the hub
    prompt = get_prompt("analysis-feedback-synthesize")
